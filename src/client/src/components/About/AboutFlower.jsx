  ...
  const cards = [
    {
      ...
      description: "Antarmuka yang ramah pengguna, cukup unggah gambar bunga dan dapatkan hasilnya."
    },
    {
      title: "Akurasi Tinggi",
      description: "Menggunakan teknologi AI yang canggih untuk klasifikasi bunga dengan akurasi tinggi."
    },
    {
      title: "Informasi Lengkap",
      description: "Menampilkan informasi detail tentang spesies bunga berdasarkan hasil klasifikasi AI."
    }
  ];
    ...
    <div className="py-8 md:py-12 lg:py-16 bg-gradient-to-br from-primary to-secondary">
      ...
      <div className="px-4 md:px-8 lg:px-16 pb-6 md:pb-10">
          ...
          <div className="flex flex-row gap-4 min-w-max px-2">
            {cards.map((card, index) => (
              ...
              >
                ...
                <p className="text-center text-sm md:text-base text-gray-700">{card.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="hidden lg:flex justify-center">
          <div className="grid grid-cols-3 gap-6 lg:gap-10 w-full max-w-6xl">
            {cards.map((card, index) => (
              <Card
                key={index}
